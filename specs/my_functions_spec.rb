...
class My_Functions < MiniTest::Test
  ...
  def test_add_length_of_arrays_b
    result = add_array_lengths( ["David", "John", "Mary"], ["Simon", "Peter", "Luke", "Andrew", "Saul"])
  ...
  def test_find_item_true_R
    # skip
    result = find_item( [ 'Hufflepuff', 'Slytherin', 'Gryffindor', 'Ravenclaw' ], "Ravenclaw" )
    assert_equal( true, result )
  end

  def test_find_item_true_G
    # skip
    result = find_item( [ 'Hufflepuff', 'Slytherin', 'Gryffindor', 'Ravenclaw' ], "Gryffindor" )
    assert_equal( true, result )
  end

  def test_find_item_false_B
    # skip
